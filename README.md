...
for how the downloads plugin and site plugin are configured.asds

# Getting started

* Fork this projectsdsdasfsasd
* Update the `pom.xml` file `<url>` element to be the address of your forkaaddsdsasdsad
